    ...
    nav: [
      { text: "首頁", link: "/" },
      {
        ...
        items: [
          ...
          { text: "進階：使用者與訂閱", link: "/tutorials/user-management" },
          { text: "進階：Aster 服務端", link: "/tutorials/linux-production" },
          { text: "故障排查", link: "/tutorials/troubleshooting" },
        ],
      },
      { text: "Aster 改了什麼", link: "/reference/mihomo-differences" },
      { text: "AnyTLS + REALITY", link: "/reference/anytls-reality" },
      { text: "設定參考", link: "/reference/configuration" },
      { text: "進階管理", link: "/aster/overview" },
    ],
    sidebar: [
      {
        text: "開始使用",
