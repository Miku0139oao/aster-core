...
import (
	...
	"github.com/Miku0139oao/aster-core/transport/masque"
...
func (w *Masque) dialQuic(ctx context.Context) (net.PacketConn, *quic.Conn, error) {
	...
	pc, quicConn, err := common.DialQuicWithConnectionIDLength(ctx, w.addr, w.DialOptions(), w.dialer, w.tlsConfig, w.quicConfig, false, 20)
	if err != nil {
		return nil, nil, err
	}
